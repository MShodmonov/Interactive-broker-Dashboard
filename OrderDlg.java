...
public class OrderDlg extends JDialog {
    ...
    public void init(String btnText, boolean btnEnabled, String dlgTitle, List<TagValue> options) {
    ...
    public void setM_symbol(JTextField m_symbol) {
        this.m_symbol = m_symbol;
    }

    public JTextField getM_symbol() {
        return m_symbol;
    }
}
